...
2. A named payer/network participation claim or payer logo without current evidence in `PTHHS_PAYER_EVIDENCE_REGISTER.md`.
3. An award, ranking, customer count, satisfaction rate, guarantee, precise founding date, or years-in-business claim without a dated source.
4. A testimonial without documented source, permission, attribution, and privacy review.
...
- Require a human compliance/administrative review before publishing a new regulated-service or payer claim.
