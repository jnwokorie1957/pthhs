...
function login_header( $title = 'Log In', $message = '', $wp_error = null ) {
	...
	?>
		<div id="login">
			<div style="padding: 10px; text-align:center;background:#fff; border-radius:8px;"><a style="display:block; box-shadow: none;" href="<?php echo get_home_url(); ?>"><img src="<?php bloginfo('template_url'); ?>/images/main-logo.png" alt="<?php echo get_bloginfo('name');?>" style="width:100%;"/></a></div>
		<?php
	/**
