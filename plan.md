...
- [x] **33. [P1] Run responsive QA at 320, 375, 768, 1024, and 1440+ widths** for nav, forms, cards, plan logos, tables, and footer. **When:** Sep 12–18. **Completed Sep 12:** Playwright verified eleven representative routes at 320, 375, 768, 1024, and 1440 pixels (55 route/viewport combinations), including navigation behavior, landmarks, footer clearance, logo containment, cards, tables, and horizontal overflow.
...
- [x] **79. [P2] Verify 200%/400% zoom and reflow** without lost content or functionality. **When:** Sep 19–Oct 2. **Completed Sep 12:** Chromium verified all eleven representative templates at 640- and 320-CSS-pixel effective widths, equivalent to 200% and 400% zoom on a 1280-pixel viewport, with no document overflow, clipped visible text, missing landmarks, off-screen primary actions, or unavailable mobile navigation.
...
- [ ] **84. [P2] Run automated plus manual accessibility tests** on Home, Services, Service Detail, Areas, Location, Insurance, Contact, Careers, Reviews, Resources, and Blog templates. **When:** Sep 19–Oct 2. **Automated Sep 12:** added axe-core mobile/desktop scans plus skip-link, focus, runtime, and reflow checks for all eleven templates; item remains open pending recorded human keyboard, screen-reader, and visual review.
...
- [x] **96. [P3] Set measurable performance budgets** for LCP, CLS, INP, total JS, and image weight and flag regressions on representative mobile pages. **When:** Oct 3–23. **Completed Sep 12:** added machine-readable Core Web Vitals and transfer budgets for eleven representative mobile routes, deterministic deploy-size enforcement in every build, and a pinned Chromium pull-request gate for responsive and performance regressions.

### G. Local SEO, content, analytics & operations

- [x] **97. [P2] Give every legitimate location page substantial unique local content** with service-area context, nearby communities, eligibility/plan caveats, and a local CTA. Avoid city-name-swap doorway pages. **When:** Sep 19–Oct 2. **Completed Sep 12:** expanded all 65 published location routes with owner-attested county context, distinct related-community links, non-medical scope, referral-specific eligibility/payer/authorization/staffing caveats, and local call/Get Started paths; CI rejects thin pages, invalid profiles, missing qualifications, and inventory drift.
...
- [ ] **100. [P2] Audit Google Business Profile information** so name, address, phone, and service areas match the website source of truth. **When:** Sep 19–Oct 2. **Public audit Sep 14:** current website, CareAvailability, Waze, and New LifeStyles signals align on name/address/phone and the inspected website URL; the item remains open until an authorized profile administrator verifies the exact owned-profile category, complete hours, website field, and configured service areas.
